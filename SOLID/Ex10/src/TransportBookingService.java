public class TransportBookingService {
    ...
    private final DistanceCalculation dist;
    private final DriverAllocation alloc;
    private final Payment pay;

    public TransportBookingService(DistanceCalculation dist, DriverAllocation alloc, Payment pay) {
